...
* Download:
  ...
  You can save the [`qunit-2.26.0.js`](https://code.jquery.com/qunit/qunit-2.26.0.js) and [`qunit-2.26.0.css`](https://code.jquery.com/qunit/qunit-2.26.0.css) files directly from the jQuery CDN.
  ...
  ```bash
  curl -o qunit.css 'https://code.jquery.com/qunit/qunit-2.26.0.css'
  curl -o qunit.js 'https://code.jquery.com/qunit/qunit-2.26.0.js'
  ```
